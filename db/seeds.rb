...
meer.landmarks.create(name: "Conservatory Garden", description: "A six acre garden in the middle of New York City, depending on the time of year you'll feel like you're either in The Favourite or The Shining.", image: "https://assets.centralparknyc.org/images/things-to-see-and-do/conservatory-garden-l.jpg")
meer.landmarks.create(name: "Lasker Rink and Swimming Pool", description: "Just south of Farmers Gate off the 2/3 train, Lasker Rink is a go-to for swimming during the summer and skating/hockey during the winter. It is currently cancelled though, as it is run by the Trump Organization.", image: "https://michaelminn.net/newyork/parks/central-park/lasker-rink/2004-03-07_16-09-41.jpg")
...
pond.locimages.create(url: "https://assets.centralparknyc.org/images/things-to-see-and-do/pond-l.jpg", alt: "pond with view of Gapstow Bridge")
...
columbus.landmarks.create(name: "Heckscher Playground", description: "This fountain heavy playground is great for burning off kids' energy.", image: "https://assets.centralparknyc.org/images/things-to-see-and-do/heckscher-playground-l.jpg")
...
columbus.locimages.create(url: "https://assets.centralparknyc.org/images/things-to-see-and-do/greyshot-arch-l.jpg", alt: "Greyshot Arch")
columbus.locimages.create(url: "https://www.starrwhitehouse.com/wp-content/uploads/2018/04/DSC02953-1.jpg", alt: "Summit Rock")
...
mall.locimages.create(url: "https://assets.centralparknyc.org/images/things-to-see-and-do/shakespeare-l.jpg", alt: "Shakespeare's statue in the Literary Walk")
...
lake.landmarks.create(name: "Loeb Boathouse", description: "In addition to being a great spot to rent a boat, this boathouse sports a bar for drinking over the pond.", image: "https://onthesetofnewyork.com/locations/whenharrymetsally/Whenharrymetsally109.jpg")
...
water.locimages.create(url: "https://assets.centralparknyc.org/images/things-to-see-and-do/kerbs-l.jpg", alt: "Kerbs Boathouse")
